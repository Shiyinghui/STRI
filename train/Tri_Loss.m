classdef Tri_Loss < dagnn.Loss
    % triplet loss
  methods
    function outputs = forward(obj, inputs, params)
      outputs{1} = triloss_improved(inputs{1}, inputs{2}, [], 'loss', obj.loss, obj.opts{:}) ;
    ...
    function [derInputs, derParams] = backward(obj, inputs, params, derOutputs)
      derInputs{1} = triloss_improved(inputs{1}, inputs{2}, derOutputs{1}, 'loss', obj.loss, obj.opts{:}) ;
      derInputs{2} = [] ;
      derParams = {} ;
    end
    ...
    function obj = Tri_Loss(varargin)
      obj.load(varargin) ;
    end
  end
end
